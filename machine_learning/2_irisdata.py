...
names = ['sepal_lenght', 'sepal_width', 
		'petal_lenght', 'petal_width', 'class']

df = pd.read_table('iris.data', header=None, names=names, sep=",")
#Seperate four data attributes and class data (the 5th attribute)
# Slice data-frame column wise. When slicing the daha frame using iloc,
