#Program ilk çalıştığında ilk kayıt sistemi sonra ders kayıt sonra da
#giris sistemi çalışsın.
#encryption kütüphanelerine bak.
#istediğim sayıda kullanıcı kayıt edebileyim. artık kullanıcı kayıt etmek
#istemediğimde ders kayıt bölümüne geçsin. 
#3 ders al sakla sonra
#giriş sisteminde kullanıcı adı ve parola isteyin, başarılı ise
#önüne ders listesi ver ders listesi seçsin
#
#
#   1)Kayıt Sistemi    3)Giriş Sistemi
